...
mod Vote {
    ...
    // ------
    // Storage (Akıllı kontratın içindeki değişkenlerin kalıcı olarak saklandığı yer)
    // ------
    struct Storage {
        yes_votes: u8,
        no_votes: u8,
    ...
    // ------
    // Constructor (Bir akıllı kontratın oluşturulması sırasında yalnızca bir kez çalışan bir işlevdir)
    // ------
    ...
    // ------
    // Getter functions with view (bir işlevin sadece okunabilir verilere erişebildiğini belirtmek için kullanılır)
    // ------
    ...
    // ------
    // External functions (bir işlevin yalnızca diğer kontratlardan çağrılabilir olduğunu belirtmek için kullanılır)
    // ------
    ...
    // ------
    // Internal Functions (bir işlevin yalnızca içinde bulunduğu kontratta veya kalıtım yapılarından çağrılabilir olduğunu belirtmek için kullanılır)
    // ------
